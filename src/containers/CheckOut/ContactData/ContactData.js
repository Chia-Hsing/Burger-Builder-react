...
class ContactData  extends Component {
    ...
    inputChangedHandler = (event, identifer) => {
        ...
        const updatedFormElement = updateObject(this.state.orderForm[identifer], {
            ...
            valid: checkValidity(event.target.value, this.state.orderForm[identifer].validation), // check whether the input empty or not.
            touched: true // make the initial input works properly.
        })

        const updatedOrderForm = updateObject(this.state.orderForm, { [identifer]: updatedFormElement })

        let formIsValid = true  // decide whether the order bottom available or not.
